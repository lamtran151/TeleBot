...
namespace Webhook.Controllers.Redis
{
    public class RedisCacher
    {
        private static Lazy<ConnectionMultiplexer> lazyConnection = new Lazy<ConnectionMultiplexer>(() =>
        {
            string cacheConnection = ConfigurationSetting.REDISConfig.CacheConnection;
        ...
        public static void RemoveCacheByPrefix(string prefix)
        {
            ...
            var server = Connection.GetServer(ConfigurationSetting.REDISConfig.CacheConnection);
